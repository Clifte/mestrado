...
\subfigure[Imagem Original]{ \includegraphics[height=3cm]{imagens/chars1.png}}
\subfigure[Dilatação - square]{
\includegraphics[height=3cm]{imagens/chars2.png}}\\
\subfigure[Dilatação - line]{
\includegraphics[height=3cm]{imagens/segmentacao.png}}
\subfigure[Dilatação - disk]{
\includegraphics[height=3cm]{imagens/segmentacao2.png}}
